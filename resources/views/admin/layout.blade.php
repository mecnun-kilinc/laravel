        ...
        <div class="d-flex flex-column flex-shrink-0 text-white p-3" style="background-color: blue">
          <div class="sidebar-logo">
            <div class="d-flex align-items-center flex-nowrap">
                <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none" href="/" aria-label="Bootstrap">
          ...
          <ul class="sidebar-menu scrollable position-relative pt-3">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link wave-effect" href="{{ url('/panel') }}">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link wave-effect" href="{{ url('/panel/article') }}">
                <span class="icon-holder">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link wave-effect" href="{{ url('/panel/reviews') }}">
                <span class="icon-holder">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link wave-effect" href="{{ url('/panel/members') }}">
                <span class="icon-holder">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            @if (Auth::user())
            <li class="nav-item">
            <a class="btn btn-primary me-2" href="{{ url('/panel/dashboard') }}">
                {{ Auth::user()->name }}
            </a>
            </li>
